...
1. Це створення кількох конструкторів із різними параметрами в одному класі. Це надає гнучкість — об'єкт можна створювати як з повним набором даних, так і з мінімальним.
